...
int64 nChainStartTime = 1399214720;
...
const string strMessageMagic = "GameLeagueCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
        nSubsidy = 500000000 * COIN;	// 0.5 billion coins, that all pow coins
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GameLeagueCoin
    bool fStrictPayToScriptHash = true; // Always active in GameLeagueCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GameLeagueCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "May 4, 2014, Putin Signs Treaty To Add Crimea To Map Of Russia.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("81c1e812ea85a8e138a306bc2399ef8dbd4a0b3684c5a2754a1fd4664845abf6"));
